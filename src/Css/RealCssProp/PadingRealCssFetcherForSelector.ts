...
export default class PaddingRealCssFetcherForSelector implements FetcherRealCssProp
{

    protected selector: BaseSelector

    constructor(htmlTag: BaseSelector)
    {
        this.selector = htmlTag
    ...
    {
        return this.selector.cssAccessor.getProperty(propName)
    }
    
    private getBaseProp(): BasePaddingCss
    {
        return <BasePaddingCss>this.selector.cssAccessor.getProperty('padding')
    }
