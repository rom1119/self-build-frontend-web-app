...
export default class KeyFrameSynchronizer implements Synchronizer
{

    protected isNowSynchronized
    protected isQueued = false
    protected model: KeyFrame
    protected api: KeyFrameApiService
    protected apiSocket: SocketApi

    constructor(selector: KeyFrame, api: KeyFrameApiService)
    {
    ...
    private updatePromise() : Promise<any>
    {
        ...
        return this.api.putKeyFrame(this.model)
