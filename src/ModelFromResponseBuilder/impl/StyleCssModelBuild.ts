    ...
    build(from: StyleCssResponse): StyleCssModel {
        ...
        if (from.multipleValue) {
            ...
            for (const cssValModel of from.cssValues) {
                ...
                cssValue.setValueSeventh(cssValModel.valueSeventh)
                cssValue.setValueEighth(cssValModel.valueEighth)
                cssValue.setValueNinth(cssValModel.valueNinth)
                ...
                cssValue.setUnitNameSeventh(cssValModel.unitNameSeventh)
                cssValue.setUnitNameEighth(cssValModel.unitNameEighth)
                cssValue.setUnitNameNinth(cssValModel.unitNameNinth)
