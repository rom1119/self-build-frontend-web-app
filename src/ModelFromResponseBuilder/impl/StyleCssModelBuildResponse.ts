    ...
    build(from: StyleCssModel ): StyleCssResponse {
        ...
        if (from.isMultiple()) {
            ...
            for (const cssValModel of from.getValues()) {
                ...
                responseCssValue.valueSeventh = cssValModel.getValueSeventh()
                responseCssValue.valueEighth = cssValModel.getValueEighth()
                responseCssValue.valueNinth = cssValModel.getValueNinth()
                ...
                responseCssValue.unitNameSeventh = cssValModel.getUnitNameSeventh()
                responseCssValue.unitNameEighth = cssValModel.getUnitNameEighth()
                responseCssValue.unitNameNinth = cssValModel.getUnitNameNinth()
