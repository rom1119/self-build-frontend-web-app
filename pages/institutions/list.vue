            ...
            <tbody>
              <template v-for="el in items">
                <tr :key="el.hashCode">
                  <td>
                    <div>
                      <img :src="el.logo" width="60" height="60" alt="" />
                    </div>
                  </td>
                  <td>
                  ...
                  <td v-if="el.amountPublications == 1">
                    {{ el.amountPublications }} Publikacja
                  </td>
                  <td
                    v-else-if="
                      el.amountPublications > 1 && el.amountPublications < 5
                    "
                  >
                    {{ el.amountPublications }} Publikacje
                  </td>
                  ...
                  <td>
                    <nuxt-link
                      ...
                      :to="{ name: 'institutions-id', params: { id: el.id } }"
                    >
                      Szczegóły
                    </nuxt-link>
                  </td>
