    ...
    <div class="white" v-if="active">
        ...
        <section class="content">
            ...
            <div>
                <label>
                    Edit
                    <input type="radio" name="layout-mode" :id="editModeName" :value="editModeName" v-model="modeName" >
                </label>
                <label>
                    View
                    <input type="radio" name="layout-mode" :id="viewModeName" :value="viewModeName" v-model="modeName" >
                </label>
            </div>
        </section>
