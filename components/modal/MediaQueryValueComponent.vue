  ...
  <div class="content-item__elem_container">
    <div class="content-item__elem">
      <select
        name="operator-first"
        @change="change"
        v-model="mediaQueryOperatorFirst"
      >
        <option v-for="operator in operators" :value="operator" :key="operator">
          {{ operator }}
        </option>
      </select>
    </div>
    ...
    <div class="content-item__elem">
      <select name="feature" @change="change" v-model="mediaFeature">
        <option v-for="feature in features" :value="feature" :key="feature">
          {{ feature }}
        </option>
      </select>
    </div>
    ...
    <div class="content-item__elem" v-context-menu="cmSizeGradientVal">
      <select-unit-context-menu
        :propertyUnit="value.featureValUnit"
        @changePropUnit="
          () => {
            value.featureValUnit = $event;
            change();
          }
        "
