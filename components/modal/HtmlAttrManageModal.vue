<template>
    ...
    <base-modal v-show="active" @changePseudoSelector="onChangePseudoSelector" :tag="value">
        ...
        <template slot="content">
            ...
            <html-attr-manage-component ref="manageComponent" :activeTag="value" /> 
...
import HtmlAttrManageComponent from '../manageComponent/component/HtmlAttrManageComponent.vue';
  

    @Component
    export default class HtmlAttrModalComponent extends AbstractModal {
      
        $refs: {
            manageComponent: HtmlAttrManageComponent
