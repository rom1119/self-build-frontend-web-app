<template >
  <base-modal
    v-show="active"
    @changePseudoSelector="onChangePseudoSelector"
    :tag="value"
  >
    <template slot="header">
      ...
      <h4>Pozycjonowanie elementu</h4>
    </template>
    <template slot="content">
      <display-manage-component ref="manageComponent" :activeTag="value" /> 
...
import DisplayManageComponent from "../manageComponent/component/DisplayManageComponent.vue";

@Component
export default class DisplayManageModalComponent extends AbstractModal {
  $refs: {
      manageComponent: DisplayManageComponent
