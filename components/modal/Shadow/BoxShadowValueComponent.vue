    ...
    <div class=" content-item__elem_container"
        >
            ...
            <div class="content-item__elem"
                 ...
                 >
                <select-unit-context-menu :propertyUnit="value.offsetYUnit" @changePropUnit="() => {value.offsetYUnit = $event; change();}" :ref="cmNameTextShadowOffY" />
            ...
            <div class="content-item__elem"
                 ...
                 >
                <select-unit-context-menu :propertyUnit="value.blurUnit" @changePropUnit="() => {value.blurUnit = $event; change();}" :ref="cmNameTextShadowBlur" />
            ...
            <div class="content-item__elem"
                 ...
                 >
                <select-unit-context-menu :propertyUnit="value.spreadUnit" @changePropUnit="() => {value.spreadUnit = $event; change();}" :ref="cmNameTextShadowSpread" />
