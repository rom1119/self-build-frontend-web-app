<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    ...
    <div class=" content-item__elem_container" :class="{'active': hasActive}"
        >
            <div v-if="value != null"  @dblclick.stop.prevent="$emit('toggleAttr')" class="content-item__elem"
                >
                ...
                <label style="display: inline-flex;" >
                    ...
                    <select v-if="isPredefinedAttr" disabled name="direction" class="select-size mr-3" @change="change" v-model="attrKey">
                    ...
                    <template v-if="!isPredefinedAttr">
                        ...
                        <input  type="text" @dblclick.stop.prevent="" @input="change" style="width: 50px;" class="input-text" v-model="attrKey"  />
            ...
            <div class="content-item__elem"
                ...
                <label :for="'textShadowOffesetX-'">
                    Value
                    <input @dblclick.stop.prevent="" type="text" @input="change" style="width: 60px;" class="input-text" v-model="value.value" name="textShadowOffesetX" :id="cmNameTextShadowOffX">
                    
                </label>
                <span v-if="!isPredefinedAttr"  class="remove-btn" style="left: 20px; position: relative; top: 0;" @click="removeVal">
                        X
                </span>
            </div>
