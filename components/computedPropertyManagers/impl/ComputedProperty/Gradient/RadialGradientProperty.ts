...
export default class RadialGradientProperty extends BaseGradientPropertyManager<RadialGradientCss> {
    ...
    createInitValue(): RadialGradientStructVal
    {
    ...
    createInitValueNext(): RadialGradientStructVal
    {
        let el = new RadialGradientStructVal()
        el.id = null
    ...
    init() {
        ...
        if (prop) {
            ...
            var direction = <RadialGradientDirection>copy.direction
