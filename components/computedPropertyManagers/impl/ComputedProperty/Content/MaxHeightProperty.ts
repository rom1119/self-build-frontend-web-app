...
import { BackgroundImage, BackgroundPosition, Height, MaxHeight } from "~/src/Css";
...
export default class MaxHeightProperty extends BaseComputedPropertyManager<MaxHeight> {

    protected value: HtmlTag
    DEFAULT_VAL = 100
    DEFAULT_UNIT = new Percent()
    property: MaxHeight = new MaxHeight(this.DEFAULT_VAL, this.DEFAULT_UNIT)
