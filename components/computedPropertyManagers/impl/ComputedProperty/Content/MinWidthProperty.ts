...
import { BackgroundImage, BackgroundPosition, Width, MinWidth } from "~/src/Css";
...
export default class MinWidthProperty extends BaseComputedPropertyManager<MinWidth> {

    protected value: HtmlTag
    DEFAULT_VAL = 100
    DEFAULT_UNIT = new Percent()
    property: MinWidth = new MinWidth(this.DEFAULT_VAL, this.DEFAULT_UNIT)
